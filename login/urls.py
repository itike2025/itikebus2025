...
urlpatterns = [
    ...
    path('login/',auth_views.LoginView.as_view(template_name='login/login.html'),name='main-login'),#login/
    path('home_user/',login_views.home_user,name='home_user'),#'home_user/
    ...
    path('password-reset/',auth_views.PasswordResetView.as_view(template_name='login/password_reset.html'),name='password-reset'),
    ...
    path('email_us/', login_views.emailUs, name='emailus'),
    path('about_us/', login_views.abouthabayeiki, name='aboutus'),
    path('delete/<int:pk>/',login_views.deleteuser,name='deleteuser'),
    path('activate/<uidb64>/<token>/',login_views.ActivateAccount.as_view(),name='activate'),
